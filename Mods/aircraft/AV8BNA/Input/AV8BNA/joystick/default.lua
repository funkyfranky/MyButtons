...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	-- Flight Instruments
	{down = iCommandADI_Test,																	name = _('Backup ADI Cage Toggle'),								category = _('Flight Instruments')},	
	{pressed = iCommandADI_ZeroPitchTrimLeft,				up = iCommandADI_Test_up,			name = _('Backup ADI Pitch Adjust Up'),							category = _('Flight Instruments')},	
	{pressed = iCommandADI_ZeroPitchTrimRight,				up = iCommandADI_Test_up,			name = _('Backup ADI Pitch Adjust Down'),						category = _('Flight Instruments')},	
	{down = iCommandAltimeterPressureIncrease,				up = iCommandAltimeterPressureStop,	name = _('Barometric Altimeter Pressure Calibration Increase'),	category = _('Flight Instruments')},
	{down = iCommandAltimeterPressureDecrease,				up = iCommandAltimeterPressureStop,	name = _('Barometric Altimeter Pressure Calibration Decrease'),	category = _('Flight Instruments')},
	{down = iCommandPlaneCMSC_PRI,																name = _('Stopwatch Start/Stop toggle'),						category = _('Flight Instruments')},
	{down = iCommandPlaneCMSC_SEP,																name = _('Stopwatch Lap/Reset toggle'),							category = _('Flight Instruments')},
	...
	-- HOTAS
	-- Stick
	{down = iCommandPlaneFire,         up = iCommandPlaneFireOff,   name = _('Trigger: Fire Gun/Launch Sidewinder, Sidearm'),     		category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = iCommandPlanePickleOn,     up = iCommandPlanePickleOff, name = _('Bomb Pickle: Release Bombs/Launch Rockets, Mavericks'),	category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = iCommandPlane_HOTAS_BoatSwitchForward,                  name = _('A/A Mode FWD: Sidewinder (Boresight)'),					category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = iCommandPlane_HOTAS_BoatSwitchAft,                      name = _('A/A Mode AFT: Sidewinder (SEAM)'),						category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = iCommandPlane_HOTAS_BoatSwitchCenter,                   name = _('A/A Mode DOWN: Gun'),										category = {_('HOTAS'), _('HOTAS - Stick')}},
	
	{pressed = iCommandPlaneTrimUp,    up = iCommandPlaneTrimStop,  name = _('Trim Pitch DOWN'),										category = {_('HOTAS'), _('HOTAS - Stick'), _('Flight Control')}},
	{pressed = iCommandPlaneTrimDown,  up = iCommandPlaneTrimStop,  name = _('Trim Pitch UP'),											category = {_('HOTAS'), _('HOTAS - Stick'), _('Flight Control')}},
	{pressed = iCommandPlaneTrimLeft,  up = iCommandPlaneTrimStop,  name = _('Trim Bank LEFT'),											category = {_('HOTAS'), _('HOTAS - Stick'), _('Flight Control')}},
	{pressed = iCommandPlaneTrimRight, up = iCommandPlaneTrimStop,  name = _('Trim Bank RIGHT'),										category = {_('HOTAS'), _('HOTAS - Stick'), _('Flight Control')}},
	
	{down = iCommandPlane_HOTAS_PinkySwitchForward,			up = iCommandPlane_HOTAS_PinkySwitchCenter,															name = _('WP Increment'),								category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = iCommandPlaneAutopilotOverrideOn,				up = iCommandPlaneAutopilotOverrideOff,																name = _('Emergency SAAHS Disconnect'),					category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = iCommandPlane_HOTAS_NoseWheelSteeringButton,	up = iCommandPlane_HOTAS_NoseWheelSteeringButtonOff,												name = _('AG Target Undesignate / NWS / FOV Toggle'),	category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = hotas_commands.SSS_FWD,							up = hotas_commands.SSS_FWD,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select FWD: INS, IRMV/EOMV'),  		category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = hotas_commands.SSS_AFT,							up = hotas_commands.SSS_AFT,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select AFT: DMT: LST/TV'),  			category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = hotas_commands.SSS_LEFT,						up = hotas_commands.SSS_LEFT,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select LEFT: MAP Center/Decenter'),	category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = hotas_commands.SSS_RIGHT,						up = hotas_commands.SSS_RIGHT,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select RIGHT: FLIR BH/WH'),			category = {_('HOTAS'), _('HOTAS - Stick')}},
	{down = hotas_commands.SSS_CENTER,						up = hotas_commands.SSS_CENTER,	cockpit_device_id = devices.MSC,	value_down = 1,	value_up = 0,	name = _('Sensor Select DOWN: HUD Scene Reject/TGP'),	category = {_('HOTAS'), _('HOTAS - Stick')}},
	
	-- Throttle
	{down = iCommandPlaneDropChaffOnce,											name = _('ECM Dispense AFT: Chaff'),		category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{down = iCommandPlaneDropFlareOnce,											name = _('ECM Dispense FWD: Flares'),		category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{down = iCommandPlaneCMDDispenceOff,										name = _('ECM Dispense RIGHT: All'),		category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{down = iCommandPlaneCMDDispence,											name = _('ECM Dispense LEFT: Mini Jammer'),	category = {_('HOTAS'), _('HOTAS - Throttle')}},
	
	{down = iCommandPlane_ABRIS_Axis_Push,										name = _('Cage/Uncage'),					category = {_('HOTAS'), _('HOTAS - Throttle')}},
	...
	{pressed = iCommandPlaneAirBrakeOff,						up = iCommandHelicopter_PPR_button_K_up,	name = _('Airbrake IN'),					category = {_('HOTAS'), _('HOTAS - Throttle')}},
	
	{pressed = iCommandPlane_HOTAS_CoolieUp,					up = iCommandPlane_HOTAS_CoolieOff, 		name = _('TDC Forward'),					category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{pressed = iCommandPlane_HOTAS_CoolieDown,  				up = iCommandPlane_HOTAS_CoolieOff, 		name = _('TDC Aft'),						category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{pressed = iCommandPlane_HOTAS_CoolieLeft,  				up = iCommandPlane_HOTAS_CoolieOff, 		name = _('TDC Left'),						category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{pressed = iCommandPlane_HOTAS_CoolieRight, 				up = iCommandPlane_HOTAS_CoolieOff, 		name = _('TDC Right'),						category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{down = iCommandPlane_HOTAS_TDC_depress_on,					up = iCommandPlane_HOTAS_TDC_depress_off,	name = _('TDC Down (Action Position)'),		category = {_('HOTAS'), _('HOTAS - Throttle')}},
	{down = iCommandPlane_HOTAS_TriggerSecondStage_Off,														name = _('TDC Action/No Action Toggle'),	category = {_('HOTAS'), _('HOTAS - Throttle')}},
	
	{down = engine_commands.Handle_THROTTLE_CUTOFF,			up = engine_commands.Handle_THROTTLE_CUTOFF,
	 cockpit_device_id = devices.DECS, value_down = 1, value_up = 0, name = _('Throttle Cutoff'),     category = {_('HOTAS'), _('HOTAS - Throttle')}},
