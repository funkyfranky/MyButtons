...
join(
	res.keyCommands,
	{
		...
		{down = misc_commands.park_brake_sw_toggle,	cockpit_device_id = devices.LGS,	value_down = 1.0,	name = _('Parking Brake Switch Toggle'),	category = {_('Landing Gear Panel')}},
		...
		{down = misc_commands.left_inlet_sw,		cockpit_device_id = devices.DEEC,	value_down = 1.0,	name = _('Left Inlet Ramp Switch AUTO'),		category = {_('Left Console'), _('Misc Panel')}},
		{down = misc_commands.left_inlet_sw,		cockpit_device_id = devices.DEEC,	value_down = 0.0,	name = _('Left Inlet Ramp Switch EMERG'),		category = {_('Left Console'), _('Misc Panel')}},
		{down = misc_commands.right_inlet_sw,		cockpit_device_id = devices.DEEC,	value_down = 1.0,	name = _('Right Inlet Ramp Switch AUTO'),		category = {_('Left Console'), _('Misc Panel')}},
		{down = misc_commands.right_inlet_sw,		cockpit_device_id = devices.DEEC,	value_down = 0.0,	name = _('Right Inlet Ramp Switch EMERG'),		category = {_('Left Console'), _('Misc Panel')}},
