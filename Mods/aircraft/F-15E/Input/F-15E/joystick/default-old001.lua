...
join(
	...
	{
		--- FF buttons
		{down = hudctrl_commands.HUD_REJ_Switch,		up = hudctrl_commands.HUD_REJ_Switch,	cockpit_device_id = devices.HUDCTRL,	value_down = -1,	value_up = 0,	name = _('HUD Symbology Reject Mode -1/0'),				category = {_('_My Buttons')}},
		{down = hudctrl_commands.HUD_REJ_Switch,		up = hudctrl_commands.HUD_REJ_Switch,	cockpit_device_id = devices.HUDCTRL,	value_down = 0,		value_up = 1,	name = _('HUD Symbology Reject Mode 0/1'),				category = {_('_My Buttons')}},
		...
		{down = iCommandPlane_HOTAS_MIC_SwitchUp,					up = iCommandPlane_HOTAS_MIC_SwitchOff,															name = _('MIC Switch FWD (Call Radio 1 Menu)'),		category = {_('Throttle Quadrant'), _('HOTAS')}},
		{down = iCommandPlane_HOTAS_MIC_SwitchDown,					up = iCommandPlane_HOTAS_MIC_SwitchOff,															name = _('MIC Switch AFT (Call Radio 2 Menu)'),		category = {_('Throttle Quadrant'), _('HOTAS')}},
		...
		{down = cnp_commands.cnpy_lever,			up = cnp_commands.cnpy_lever,			cockpit_device_id = devices.CNPYSYST,	value_down = 1.0,	value_up = 0.0,	name = _('Canopy_Handdle'),				category = _('Systems')},
		...
		{down = misc_commands.seat_arm_handle,												cockpit_device_id = devices.CNPYSYST,	value_down = 1.0,					name = _('Ejection Seat Arm'),			category = _('Systems')},
		{down = misc_commands.seat_arm_handle,												cockpit_device_id = devices.CNPYSYST,	value_down = 0.0,					name = _('Ejection Seat Safe'),			category = _('Systems')},
		...
		{down = hudctrl_commands.HUD_BRT_Knob_KB,											cockpit_device_id = devices.HUDCTRL,		value_down = 0.1,					name = _('HUD Britghness +10%'),							category = _('HUD Control')},
		{down = hudctrl_commands.HUD_BRT_Knob_KB,											cockpit_device_id = devices.HUDCTRL,		value_down =-0.1,					name = _('HUD Britghness -10%'),							category = _('HUD Control')},
		{down = hudctrl_commands.HUD_REJ_Switch_KB,											cockpit_device_id = devices.HUDCTRL,		value_down =-0.5,					name = _('HUD Reject DOWN'),								category = _('HUD Control')},
		{down = hudctrl_commands.HUD_REJ_Switch_KB,											cockpit_device_id = devices.HUDCTRL,		value_down = 0.5,					name = _('HUD Reject UP'),									category = _('HUD Control')},
		...
		{down = hudctrl_commands.HUD_VIDEO_BRT_Knob_KB,										cockpit_device_id = devices.HUDCTRL,		value_down = 0.1,					name = _('HUD Video Britghness +10%'),						category = _('HUD Control')},
		{down = hudctrl_commands.HUD_VIDEO_BRT_Knob_KB,										cockpit_device_id = devices.HUDCTRL,		value_down =-0.1,					name = _('HUD Video Britghness -10%'),						category = _('HUD Control')},
		...
		{down = misc_commands.park_brake_sw,	cockpit_device_id = devices.LGS,	value_down = 1.0,	name = _('Parking Brake Switch Toggle'),	category = {_('Landing Gear Panel')}},
		{down = misc_commands.park_brake_sw,	cockpit_device_id = devices.LGS,	value_down = 1.0,	name = _('Parking Brake Switch ON'),		category = {_('Landing Gear Panel')}},
		{down = misc_commands.park_brake_sw,	cockpit_device_id = devices.LGS,	value_down = 0.0,	name = _('Parking Brake Switch OFF'),		category = {_('Landing Gear Panel')}},
		...
		{pressed = volctrl_commands.launch_vol,		up = volctrl_commands.launch_vol,	cockpit_device_id = devices.WCAS,	value_down =  1.0,	value_up = 0.0,	name = _('TEWS Launch Warning Volume INCR'),	category = {_('Left Console'), _('Volume Control Panel')}},
		{pressed = volctrl_commands.launch_vol,		up = volctrl_commands.launch_vol,	cockpit_device_id = devices.WCAS,	value_down = -1.0,	value_up = 0.0,	name = _('TEWS Launch Warning Volume DECR'),	category = {_('Left Console'), _('Volume Control Panel')}},
		{pressed = volctrl_commands.ics_vol,		up = volctrl_commands.ics_vol,		cockpit_device_id = devices.ICS,	value_down =  1.0,	value_up = 0.0,	name = _('Intercom Volume INCR'),				category = {_('Left Console'), _('Volume Control Panel')}},
		{pressed = volctrl_commands.ics_vol,		up = volctrl_commands.ics_vol,		cockpit_device_id = devices.ICS,	value_down = -1.0,	value_up = 0.0,	name = _('Intercom Volume DECR'),				category = {_('Left Console'), _('Volume Control Panel')}},
		{pressed = volctrl_commands.wpn_vol,		up = volctrl_commands.wpn_vol,		cockpit_device_id = devices.WCAS,	value_down =  1.0,	value_up = 0.0,	name = _('Weapons Tone Volume INCR'),			category = {_('Left Console'), _('Volume Control Panel')}},
		{pressed = volctrl_commands.wpn_vol,		up = volctrl_commands.wpn_vol,		cockpit_device_id = devices.WCAS,	value_down = -1.0,	value_up = 0.0,	name = _('Weapons Tone Volume DECR'),			category = {_('Left Console'), _('Volume Control Panel')}},
		{pressed = volctrl_commands.ils_vol,		up = volctrl_commands.ils_vol,		cockpit_device_id = devices.ICS,	value_down =  1.0,	value_up = 0.0,	name = _('ILS Tone Volume INCR'),				category = {_('Left Console'), _('Volume Control Panel')}},
		{pressed = volctrl_commands.ils_vol,		up = volctrl_commands.ils_vol,		cockpit_device_id = devices.ICS,	value_down = -1.0,	value_up = 0.0,	name = _('ILS Tone Volume DECR'),				category = {_('Left Console'), _('Volume Control Panel')}},
		...
		-- MISC Panel -----------------------------
		---------------------------------------------
		{down = micsctrl_commands.crypto_sw,		up = micsctrl_commands.crypto_sw,	cockpit_device_id = devices.ICS,	value_down =  1.0,	value_up = 0.0,	name = _('CRYPTO Switch UP'),					category = {_('Left Console'), _('Volume Control Panel')}},
		{down = micsctrl_commands.crypto_sw,		up = micsctrl_commands.crypto_sw,	cockpit_device_id = devices.ICS,	value_down = -1.0,	value_up = 0.0,	name = _('CRYPTO Switch DOWN'),					category = {_('Left Console'), _('Volume Control Panel')}},
		{down = micsctrl_commands.mic_sw,			up = micsctrl_commands.mic_sw,		cockpit_device_id = devices.ICS,	value_down =  1.0,	value_up = 0.0,	name = _('MIC Switch UP'),						category = {_('Left Console'), _('Volume Control Panel')}},
		{down = micsctrl_commands.mic_sw,			up = micsctrl_commands.mic_sw,		cockpit_device_id = devices.ICS,	value_down = -1.0,	value_up = 0.0,	name = _('MIC Switch DOWN'),					category = {_('Left Console'), _('Volume Control Panel')}},
		...
		-- Sensors Panel ----------------------------
		---------------------------------------------
		{down = snsrctrl_commands.tf_rdr_kb,											cockpit_device_id = devices.NAVPOD,		value_down =  0.50,					name = _('Terrrain Follow Radar: OFF/STBY/ON'),		category = {_('Left Console'), _('Sensors Panel')}},
		{down = snsrctrl_commands.tf_rdr_kb,											cockpit_device_id = devices.NAVPOD,		value_down = -0.50,					name = _('Terrrain Follow Radar: ON/STBY/OFF'),		category = {_('Left Console'), _('Sensors Panel')}},
		{down = snsrctrl_commands.rdr_alt_kb,											cockpit_device_id = devices.ADC,		value_down =  0.50,					name = _('Radar Altimeter: OFF/ON/OVERRIDE'),		category = {_('Left Console'), _('Sensors Panel')}},
		{down = snsrctrl_commands.rdr_alt_kb,											cockpit_device_id = devices.ADC,		value_down = -0.50,					name = _('Radar Altimeter: OVERRIDE/ON/OFF'),		category = {_('Left Console'), _('Sensors Panel')}},
		...
		{down = cas_commands.tf_couple_sw,	cockpit_device_id = devices.FLCTRL,	value_down =  0.0,	name = _('TF Couple Switch ON'), category = {_('Left Console'), _('CAS Panel')}},
		{down = cas_commands.tf_couple_sw,	cockpit_device_id = devices.FLCTRL,	value_down =  1.0,	name = _('TF Couple Switch OFF'), category = {_('Left Console'), _('CAS Panel')}},
		...
		{down = engpnl_commands.generator_emerg_sw,		cockpit_device_id = devices.EPSS,	value_down =  1.0,	name = _('Emergency Generator Switch AUTO'), category = {_('Right Console'), _('Engine Panel')}},
		...
		{down = engpnl_commands.generator_emerg_sw,		cockpit_device_id = devices.EPSS,	value_down =  0.0,	name = _('Emergency Generator Switch ISOLATE'), category = {_('Right Console'), _('Engine Panel')}},
		...
		{down = engpnl_commands.ground_power_sw_reset,	up = engpnl_commands.ground_power_sw_reset, cockpit_device_id = devices.EPSS,	value_down = 1.0,	value_up = 0.0, name = _('External Power Switch RESET'), category = {_('Right Console'), _('Engine Panel')}},
		...
		{down = snsrctrl_commands.tf_rdr_sw,		cockpit_device_id = devices.NAVPOD,		value_down =  0.0,	name = _('Terrrain Follow Radar: OFF'),		category = {_('Joystick Switch Abstractions')}},
		{down = snsrctrl_commands.tf_rdr_sw,		cockpit_device_id = devices.NAVPOD,		value_down =  0.5,	name = _('Terrrain Follow Radar: STBY'),	category = {_('Joystick Switch Abstractions')}},
		{down = snsrctrl_commands.tf_rdr_sw,		cockpit_device_id = devices.NAVPOD,		value_down =  1.0,	name = _('Terrrain Follow Radar: ON'),		category = {_('Joystick Switch Abstractions')}},
		{down = snsrctrl_commands.rdr_alt_sw,		cockpit_device_id = devices.ADC,		value_down =  0.0,	name = _('Radar Altimeter: OFF'),			category = {_('Joystick Switch Abstractions')}},
		{down = snsrctrl_commands.rdr_alt_sw,		cockpit_device_id = devices.ADC,		value_down =  0.5,	name = _('Radar Altimeter: ON'),			category = {_('Joystick Switch Abstractions')}},
		{down = snsrctrl_commands.rdr_alt_sw,		cockpit_device_id = devices.ADC,		value_down =  1.0,	name = _('Radar Altimeter: OVERRIDE'),		category = {_('Joystick Switch Abstractions')}},
...
join(
	res.axisCommands,
	{
		...
		--- FF additional start
		{action = volctrl_commands.rc_caution_vol,		cockpit_device_id = devices.TEWS,		name = _('FF Caution Volume')},
		{action = volctrl_commands.rc_launch_vol,		cockpit_device_id = devices.TEWS,		name = _('FF Launch Volume')},
		--- FF additional end
