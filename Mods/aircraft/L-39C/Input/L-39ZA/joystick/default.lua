...
-- {down = electric_commands.L39C_Command_MainGeneratorSw_EXT, up = electric_commands.L39C_Command_MainGeneratorSw_EXT, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1.0,  value_up = 0.0, name = _('Main Generator Switch On/Off'), category = {_('_My Buttons')}},
-- {down = electric_commands.L39C_Command_CB_SDU_EXT,          up = electric_commands.L39C_Command_CB_SDU_EXT,	         cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1.0,  value_up = 0.0, name = _('CB SDU Switch On/Off'),         category = {_('_My Buttons')}},
...
{down = device_commands.Button_48, up = device_commands.Button_49, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1, value_up = 0, name = _('Outboard Stations Select/Deselect'), category = {_('_My Buttons')}},
{down = device_commands.Button_50, up = device_commands.Button_51, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1, value_up = 0, name = _('Inboard Stations Select/Deselect'),  category = {_('_My Buttons')}},

{down = device_commands.Button_75, up = device_commands.Button_75, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = -1, value_up = 0, name = _('Bomb Series Selector SALVO/I'), category = {_('_My Buttons')}},
{down = device_commands.Button_75, up = device_commands.Button_75, cockpit_device_id = devices.WEAPON_SYSTEM, value_down =  1, value_up = 0, name = _('Bomb Series Selector TRAIN/I'), category = {_('_My Buttons')}},

{down = device_commands.Button_34, up = device_commands.Button_34, cockpit_device_id = devices.WEAPON_SYSTEM, value_down = 1, value_up = -1, name = _('Missile/Bomb Release PORT(Left)/STARB(Right)'), category = {_('_My Buttons')}},
