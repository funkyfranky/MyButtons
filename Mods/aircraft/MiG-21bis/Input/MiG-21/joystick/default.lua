...
--- taxi light
{down=device_commands.LandingLights_mouse,up=device_commands.LandingLights_mouse,cockpit_device_id=devices.LIGHTS,value_down=0.0,value_up=0.5,name='Landing Lights Off/Taxi',category='_My Buttons'},
{down=device_commands.LandingLights_mouse,up=device_commands.LandingLights_mouse,cockpit_device_id=devices.LIGHTS,value_down=1.0,value_up=0.5,name='Landing Lights On/Taxi',category='_My Buttons'},
--- battery
...
{down=device_commands.ASPssNeutrRns, up=device_commands.ASPssNeutrRns, cockpit_device_id=devices.WEAPON_CONTROL, value_down=0.0, value_up=0.5, name='Weapon AA Mode SAR/Neutral',category='_My Buttons'},
{down=device_commands.ASPssNeutrRns, up=device_commands.ASPssNeutrRns, cockpit_device_id=devices.WEAPON_CONTROL, value_down=1.0, value_up=0.5, name='Weapon AA Mode IR/Neutral',category='_My Buttons'},
{down=device_commands.TaktSbros, up=device_commands.TaktSbros, cockpit_device_id=devices.WEAPON_CONTROL, value_down=1.0, value_up=0.0, name='Tactical Drop On/Off',category='_My Buttons'},
...
{down=device_commands.ASPssGiroSelect_2pos,up=device_commands.ASPssGiroSelect_2pos,cockpit_device_id=devices.ASP,value_down=0.0,value_up=1.0,name='ASP Mode Giro/Missiles',category='_My Buttons'},
...
--- flaps
{down=device_commands.Flaps0,  up=device_commands.Flaps25, cockpit_device_id=devices.FLAPS, value_down=1.0, value_up=1.0, name='Flaps 0/25', category='_My Buttons'},
{down=device_commands.Flaps45, up=device_commands.Flaps25, cockpit_device_id=devices.FLAPS, value_down=1.0, value_up=1.0, name='Flaps 45/25', category='_My Buttons'},
--- RSBN
{down=device_commands.RSBNARK,  up=device_commands.RSBNARK,  cockpit_device_id=devices.RSBN, value_down=1.0, value_up=1.0, name='NPP RSBN/ARK Toggle', category='_My Buttons'},
{down=device_commands.RSBNmode, up=device_commands.RSBNmode, cockpit_device_id=devices.RSBN, value_down=1.0, value_up=0.5, name='RSBN Mode Descend/Navigation', category='_My Buttons'},
{down=device_commands.RSBNmode, up=device_commands.RSBNmode, cockpit_device_id=devices.RSBN, value_down=0.0, value_up=0.5, name='RSBN Mode Landing/Navigation', category='_My Buttons'},
--- afterburner
{down=device_commands.ForsMax,  up=device_commands.ForsMax,  cockpit_device_id=devices.ENGINE, value_down=1.0, value_up=1.0, name='Afterburner Maximum On/Off Toggle',category='_My Buttons'},
{down=device_commands.Chr_2pos, up=device_commands.Chr_2pos, cockpit_device_id=devices.ENGINE, value_down=1.0, value_up=0.0, name='Emergency Afterburner On/Off (mybuttons)',category='_My Buttons'},
--- pitot tube
{down=device_commands.PitoHeatMain, up=device_commands.PitoHeatMain, cockpit_device_id=devices.PITOT_TUBES, value_down=1.0, value_up=1.0, name='Pitot Tube Heating On/Off (Toggle)',category='_My Buttons'},
{down=device_commands.PitoHeatAux,  up=device_commands.PitoHeatAux,  cockpit_device_id=devices.PITOT_TUBES, value_down=1.0, value_up=1.0, name='Emergency Pitot Tube Heating On/Off (Toggle)',category='_My Buttons'},
--- throttle
{down=device_commands.RUDStop_lock,up=device_commands.RUDStop_lock,cockpit_device_id=devices.ENGINE_START_DEVICE,value_down=1.0,value_up=1.0,name='Throttle Stop/Start Position Toggle',category='_My Buttons'},
...
--- air start
{down=device_commands.AirStart_2pos, up=device_commands.AirStart_2pos, cockpit_device_id=devices.ENGINE_START_DEVICE,value_down=1.0, value_up=0.0, name='Engine Emergency Air Start On/Off',category='_My Buttons'},
--- lines added which are not here by default, i.e. taken from clickabledata.lua
--- sprd rato
{down=device_commands.SPRDstartOn, cockpit_device_id=devices.SPRD,value_down=1.0, name='SPRD (RATO) System On/Off', category='_My Buttons'},
{down=device_commands.SPRDdropOn,  cockpit_device_id=devices.SPRD,value_down=1.0, name='SPRD (RATO) Drop System On/Off', category='_My Buttons'},
--- radio/compass
{down=device_commands.RadioCompassSound, up=device_commands.RadioCompassSound, cockpit_device_id=devices.RADIO, value_down=1.0, value_up=0.0, name='ARK Radio/Compass Sound', category='_My Buttons'},
-- IFF
{down=device_commands.SRZOvopros, cockpit_device_id=devices.SRZO, value_down=1.0, name='SRZO IFF Coder/Decoder On/(Off)', category='_My Buttons'},
{down=device_commands.SODon,      cockpit_device_id=devices.SOD,  value_down=1.0, name='SOD IFF On/Off', category='_My Buttons'},
{down=device_commands.SRZOon,     cockpit_device_id=devices.SRZO, value_down=1.0, name='IFF System Type 81 On/Off', category='_My Buttons'},
--{down=device_commands.SRZOon, up=device_commands.SRZOon, cockpit_device_id=devices.SRZO, value_down=1.0, value_up=0.0, name='IFF System Type 81 On/Off', category='_My Buttons'},
{down=device_commands.NPPnastrojka, cockpit_device_id=devices.KSI, value_down=1.0, name='NPP Adjust', category='_My Buttons'},
...
{combos={{key='C',reformers={'LShift'}}},down=device_commands.CanopyLockHandle,cockpit_device_id=devices.CANOPY,value_down=1.0,name='Canopy Locked/Unlocked',category='Life support'},
...
{down=device_commands.LandingLights_Off,cockpit_device_id=devices.LIGHTS,value_down=0.0,name='Landing Lights OFF',category='Lights'},
{down=device_commands.LandingLights_Taxi,cockpit_device_id=devices.LIGHTS,value_down=0.5,name='Landing Lights TAXI',category='Lights'},
{down=device_commands.LandingLights_Landing,cockpit_device_id=devices.LIGHTS,value_down=1.0,name='Landing Lights LANDING',category='Lights'},
...
--/N/ since 09.03.2016.
{down=device_commands.RadioOn,cockpit_device_id=devices.RADIO,value_down=1.0,name='Radio on',category='Radio Communications'},
{down=device_commands.RadioOn,cockpit_device_id=devices.RADIO,value_down=0.0,name='Radio off',category='Radio Communications'},

-- Radio
{pressed=device_commands.RadioVolume_kb,cockpit_device_id=devices.RADIO,value_pressed=0.01,name='Radio Volume +',category='Radio Communications'},

{pressed=device_commands.RadioVolume_kb,cockpit_device_id=devices.RADIO,value_pressed=-0.01,name='Radio Volume -',category='Radio Communications'},

{down=device_commands.RadioChannel_kb,cockpit_device_id=devices.RADIO,value_down=0.05,name='Radio channel +',category='Radio Communications'},

{down=device_commands.RadioChannel_kb,cockpit_device_id=devices.RADIO,value_down=-0.05,name='Radio channel -',category='Radio Communications'},

{down=device_commands.RadioOn_kb,cockpit_device_id=devices.RADIO,value_down=1.0,name='Radio on/off',category='Radio Communications'},
...
{cockpit_device_id=devices.ASP,action=device_commands.RUDoblog_axis,name='TDC Range / Pipper Span control'},
