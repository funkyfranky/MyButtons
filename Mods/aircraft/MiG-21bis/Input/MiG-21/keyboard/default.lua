...
--/N/ added 31.01.2015.
{combos={{key='M'}},down=iCommandToggleMirrors,name='Toggle Mirror',category=_('View')},
{combos={{key='B',reformers = {'LAlt'}}},down = iCommandViewBriefing,name='View briefing on/off',category = _('General')},
...
-- Flight Control
{combos = {{key = 'Up'}},									down = iCommandPlaneUpStart, up = iCommandPlaneUpStop, name = 'Flight Nose Down', category = 'Flight Controls'},
{combos = {{key = 'Down'}},									down = iCommandPlaneDownStart, up = iCommandPlaneDownStop, name = 'Flight Nose Up', category = 'Flight Controls'},
{combos = {{key = 'Left'}},									down = iCommandPlaneLeftStart, up = iCommandPlaneLeftStop, name = 'Flight Left Wing Down', category = 'Flight Controls'},
{combos = {{key = 'Right'}},								down = iCommandPlaneRightStart, up = iCommandPlaneRightStop, name = 'Flight Right Wing Down', category = 'Flight Controls'},
{combos = {{key = 'Z'}},									down = iCommandPlaneLeftRudderStart, up = iCommandPlaneLeftRudderStop, name = 'Flight Rudder Left', category = 'Flight Controls'},
{combos = {{key = 'X'}},									down = iCommandPlaneRightRudderStart, up = iCommandPlaneRightRudderStop, name = 'Flight Rudder Right', category = 'Flight Controls'},
...
-- ARU
{combos={{key='U',reformers={'RAlt'}}},down=device_commands.ARUmanAuto,cockpit_device_id=devices.ARU,value_down=1.0,name='ARU - Auto/Manual',category='Flight Controls'},
...
{combos={{key='W',reformers={'RShift'}}},down=device_commands.ABSon,cockpit_device_id=devices.GEAR_BRAKES,value_down=1.0,name='ABS On/Off',category='Gears, brakes and chute'},
{combos={{key='W',reformers={'LAlt'}}},down=device_commands.NosegearBrake,cockpit_device_id=devices.GEAR_BRAKES,value_down=1.0,name='Nosegear Brake On/Off',category='Gears, brakes and chute'},
{combos={{key='W',reformers={'LCtrl'}}},down=device_commands.EmergBrakes,cockpit_device_id=devices.GEAR_BRAKES,value_down=1.0,name='Emergency Braking On/Off',category='Gears, brakes and chute'},
...
-- ASP
{combos={{key='S'}},pressed=device_commands.ASPtargetSize_kb,up=device_commands.ASPtargetSize_kb,cockpit_device_id=devices.ASP,value_pressed=0.01,name='Target Size +',category='Weapons / ASP'},

{combos={{key='S',reformers={'LAlt'}}},pressed=device_commands.ASPtargetSize_kb,up=device_commands.ASPtargetSize_kb,cockpit_device_id=devices.ASP,value_pressed=-0.01,name='Target Size -',category='Weapons / ASP'},

{combos={{key='I'}},pressed=device_commands.ASPinterceptAngle_kb,up=device_commands.ASPinterceptAngle_kb,cockpit_device_id=devices.ASP,value_pressed=0.01,name='Intercept Angle +',category='Weapons / ASP'},

{combos={{key='I',reformers={'LAlt'}}},pressed=device_commands.ASPinterceptAngle_kb,up=device_commands.ASPinterceptAngle_kb,cockpit_device_id=devices.ASP,value_pressed=-0.01,name='Intercept Angle -',category='Weapons / ASP'},

-- SPO 
{combos={{key='V'}},pressed=device_commands.SPOvolume_kb,up=device_commands.SPOvolume_kb,cockpit_device_id=devices.SPO,value_pressed=0.05,name='SPO-10 Volume +',category='Radar and SPO'},

{combos={{key='V',reformers={'LAlt'}}},pressed=device_commands.SPOvolume_kb,up=device_commands.SPOvolume_kb,cockpit_device_id=devices.SPO,value_pressed=-0.05,name='SPO-10 Volume -',category='Radar and SPO'},

-- KPP
{combos={{key='K',reformers={'LShift'}}},pressed=device_commands.KPPsetPitch_kb,up=device_commands.KPPsetPitch_kb,cockpit_device_id=devices.KPP,value_pressed=0.02,name='KPP set pitch +',category='Avionics'},

{combos={{key='K',reformers={'LCtrl'}}},pressed=device_commands.KPPsetPitch_kb,up=device_commands.KPPsetPitch_kb,cockpit_device_id=devices.KPP,value_pressed=-0.02,name='KPP Set pitch -',category='Avionics'},

-- RSBN
{combos={{key='Y'}},pressed=device_commands.RSBNnav_kb,cockpit_device_id=devices.RSBN,value_pressed=0.01,name='RSBN nav chnl +',category='Avionics'},

{combos={{key='Y',reformers={'LShift'}}},pressed=device_commands.RSBNnav_kb,cockpit_device_id=devices.RSBN,value_pressed=-0.01,name='RSBN nav chnl -',category='Avionics'},

{combos={{key='U'}},pressed=device_commands.RSBNland_kb,cockpit_device_id=devices.RSBN,value_pressed=0.01,name='RSBN land chnl +',category='Avionics'},

{combos={{key='U',reformers={'LShift'}}},pressed=device_commands.RSBNland_kb,cockpit_device_id=devices.RSBN,value_pressed=-0.01,name='RSBN land chnl -',category='Avionics'},

-- Radio
{combos={{key='H'}},pressed=device_commands.RadioVolume_kb,cockpit_device_id=devices.RADIO,value_pressed=0.01,name='Radio Volume +',category='Radio Communications'},

{combos={{key='H',reformers={'LCtrl'}}},pressed=device_commands.RadioVolume_kb,cockpit_device_id=devices.RADIO,value_pressed=-0.01,name='Radio Volume -',category='Radio Communications'},

{combos={{key='['}},down=device_commands.RadioChannel_kb,cockpit_device_id=devices.RADIO,value_down=0.05,name='Radio channel +',category='Radio Communications'},

{combos={{key=']'}},down=device_commands.RadioChannel_kb,cockpit_device_id=devices.RADIO,value_down=-0.05,name='Radio channel -',category='Radio Communications'},

{combos={{key='/'}},down=device_commands.RadioOn_kb,cockpit_device_id=devices.RADIO,value_down=1.0,name='Radio on/off',category='Radio Communications'},
