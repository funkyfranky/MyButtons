...
{combos = {{key = "JOY_BTN6"}, },	down = iCommandToggleCommandMenu, name = _('Communication menu'), category = _('Communications')},
...
{combos = {{key = "JOY_BTN12"}, },	down = iCommandPlaneTrimUp,	up = iCommandPlaneTrimUp,	 value_down = 1, value_up = 0, name = _('Elevator Trimmer Switch, PULL(CLIMB)'),	category = _('Flight Control')},
{combos = {{key = "JOY_BTN11"}, },	down = iCommandPlaneTrimDown,	up = iCommandPlaneTrimDown,	 value_down = 1, value_up = 0, name = _('Elevator Trimmer Switch, PUSH(DESCEND)'),	category = _('Flight Control')},
...
-- Throttle Grip
{combos = {{key = "JOY_BTN15"}, },	down = electric_commands.Mig15_Command_EngineStartBtn,	up = electric_commands.Mig15_Command_EngineStartBtn, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1, value_up = 0, name = _('Engine Start Button'),	category = _('Throttle Grip')},
...
{combos = {{key = "JOY_BTN4"}, },	down = RSI_6K_commands.Mig15_Command_RSI6K_MicBtn, up = RSI_6K_commands.Mig15_Command_RSI6K_MicBtn, cockpit_device_id = devices.RSI_6K, value_down = 1, value_up = 0, name = _('Microphone Button'), category = _('Throttle Grip')},
...
{down = iCommandPlaneFire, up = iCommandPlaneFireOff, name = _('NR-23 Cannon Fire Button'), category = _('Stick')},
{down = device_commands.Button_1, up = device_commands.Button_1, cockpit_device_id  = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('N-37D Cannon Fire Button'), category = _('Stick')},
...
{combos = {{key = "JOY_SLIDER1", filter = {curvature = {0}, deadzone = 0, invert = true, saturationX = 1, saturationY = 1, slider = false},}, },	action = device_commands.Button_6,	cockpit_device_id = devices.ASP_3N,	name = _('ASP-3N Gunsight Target Distance'),					category = {_('ASP-3N Gunsight')}},
