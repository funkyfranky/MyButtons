...
-- Circuit breakers ----------------------------
------------------------------------------------
{combos = {{key = "JOY_BTN5"}, },	down = device_commands.Button_22, up = device_commands.Button_22, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1.0, value_up = 0.0,	name = _('Group 1 CB switcher'),	category = {_('Overhead CB Panels')}},
{combos = {{key = "JOY_BTN6"}, },	down = device_commands.Button_23, up = device_commands.Button_23, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1.0, value_up = 0.0,	name = _('Group 2 CB switcher'),	category = {_('Overhead CB Panels')}},
{combos = {{key = "JOY_BTN7"}, },	down = device_commands.Button_24, up = device_commands.Button_24, cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1.0, value_up = 0.0,	name = _('Group 3 CB switcher'),	category = {_('Overhead CB Panels')}},
...
{combos = {{key = "JOY_BTN9"}, },	down = device_commands.Button_65,									cockpit_device_id = devices.WEAPON_SYS,	value_down = 1.0,					name = _('RS/GUV Selector Switch - ON/OFF'),				category = {_('Overhead CB Panels'), _('Armament System')}},
...
{combos = {{key = "JOY_BTN10"}, },	down = device_commands.Button_69,	cockpit_device_id = devices.WEAPON_SYS,	value_down = 1.0,		name = _('Main Bomb Switch - ON/OFF'),									category = {_('Right Weapons Control Panel'), _('Armament System')}},
...
{combos = {{key = "JOY_BTN12"}, },	down = device_commands.Button_71,	cockpit_device_id = devices.WEAPON_SYS,	value_down = 1.0,		name = _('Pylon Setup Selector Switch - CW'),							category = {_('Right Weapons Control Panel'), _('Armament System')}},
{combos = {{key = "JOY_BTN11"}, },	down = device_commands.Button_71,	cockpit_device_id = devices.WEAPON_SYS,	value_down = -1.0,		name = _('Pylon Setup Selector Switch - CCW'),							category = {_('Right Weapons Control Panel'), _('Armament System')}},

------------------------------------------------
-- Armament System -----------------------------
------------------------------------------------
-- Overhead
{combos = {{key = "JOY_BTN8"}, },	down = device_commands.Button_54,	cockpit_device_id = devices.WEAPON_SYS,	value_down = 1.0,	name = _('Weapon Safe/Armed Switch - ON/OFF'),	category = {_('Armament System')}},
...
--
{combos = {{key = "JOY_BTN1"}, },	down = device_commands.Button_11, up = device_commands.Button_11,	cockpit_device_id = devices.WEAPON_SYS,	value_down = 1.0, value_up = 0.0,	name = _('Release Bomb'),	category = {_('Armament System')}},
...
{combos = {{key = "JOY_Z"}, },	action = iCommandPlaneThrustCommon,	name = _('Corrector')},
