...
{combos = {{key = "JOY_BTN6"}, },							down = iCommandPlaneTrimOn, up = iCommandPlaneTrimOff,																					name = _('Trimmer Button'),				category = {_('Ins Cyclic Stick'), _('Trimmer')}},
{combos = {{key = "JOY_BTN6", reformers = {"LCtrl"}}, },	down = iCommandPlaneTrimCancel,																											name = _('Trimmer - Reset'),			category = {_('Ins Cyclic Stick'), _('Trimmer')}},
...
{combos = {{key = "JOY_BTN3"}, },	down = iCommandAutopilotEmergOFF,	up = iCommandAutopilotEmergOFF_up,																	name = _('Turn Off Autopilot Button'),	category = {_('Ins Cyclic Stick'), _('Autopilot')}},
...
-- Weapon System
{combos = {{key = "JOY_BTN4"}, },							down = device_commands.Button_55,	cockpit_device_id = devices.WEAPON_SYS, value_down = 1.0,	name = _('Rocket Serie 8-16-4 Switch - Up'),					category = {_('Left Overhead Panel'), _('Armament System')}},
{combos = {{key = "JOY_BTN4", reformers = {"LCtrl"}}, },	down = device_commands.Button_55,	cockpit_device_id = devices.WEAPON_SYS, value_down = -1.0,	name = _('Rocket Serie 8-16-4 Switch - Down'),					category = {_('Left Overhead Panel'), _('Armament System')}},
...
{combos = {{key = "JOY_BTN3", reformers = {"LCtrl"}}, },	down = device_commands.Button_2, up = device_commands.Button_2, value_down = 1, value_up = 0,	cockpit_device_id = devices.AUTOPILOT,	name = _('Autopilot Roll/Pitch Channel ON Button'),			category = {_('Center Console'), _('Autopilot')}},
