...
-- External Lights
{down = device_commands.Button_12, up = device_commands.Button_12, cockpit_device_id = devices.NAVLIGHT_SYSTEM,	value_down =-1.0, value_ up = 0.0, name = _('Nav. Lights Dim/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_12, up = device_commands.Button_12, cockpit_device_id = devices.NAVLIGHT_SYSTEM,	value_down = 1.0, value_ up = 0.0, name = _('Nav. Lights Bright/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_13, up = device_commands.Button_13, cockpit_device_id = devices.NAVLIGHT_SYSTEM,	value_down =-1.0, value_ up = 0.0, name = _('Formation Lights Dim/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_13, up = device_commands.Button_13, cockpit_device_id = devices.NAVLIGHT_SYSTEM,	value_down = 1.0, value_ up = 0.0, name = _('Formation Lights Bright/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_14, up = device_commands.Button_14, cockpit_device_id = devices.NAVLIGHT_SYSTEM,	value_down = 1.0, value_ up = 0.0, name = _('Tip Lights On/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_15, up = device_commands.Button_15, cockpit_device_id = devices.NAVLIGHT_SYSTEM,	value_down = 1.0, value_ up = 0.0, name = _('Strobe Light On/Off'), category = {_('_My Buttons')}},
-- Engines
{down = device_commands.Button_28, up = device_commands.Button_28, cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 1.0, value_ up = 0.0, name = _('Engine Dust Protection Left Switch On/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_29, up = device_commands.Button_29, cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 1.0, value_ up = 0.0, name = _('Engine Dust Protection Right Switch On/Off'), category = {_('_My Buttons')}},
-- Heating
{down = device_commands.Button_38, up = device_commands.Button_38, cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 1.0, value_ up = 0.0, name = _('Pitot Heater Left Switch On/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_39, up = device_commands.Button_39, cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 1.0, value_ up = 0.0, name = _('Pitot Heater Right Switch On/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_6,  up = device_commands.Button_6,  cockpit_device_id = devices.CLOCK,            value_down = 1.0, value_ up = 0.0, name = _('Clock Heating Switch On/Off'), category = {_('_My Buttons')}},
--{down = cb_start_cmd+75,           up = cb_start_cmd+75,           cockpit_device_id = devices.ENGINE_INTERFACE, value_down = 1.0, value_ up = 0.0, name = _('Battery Heating Switch On/Off'), category = {_('_My Buttons')}},
--
{down = device_commands.Button_5,  up = device_commands.Button_5,  cockpit_device_id = devices.SYS_CONTROLLER,   value_down = 1.0, value_ up = 0.0, name = _('Flasher Switch On/Off'), category = {_('_My Buttons')}},
{down = device_commands.Button_6,  up = device_commands.Button_6,  cockpit_device_id = devices.SYS_CONTROLLER,   value_down = 1.0, value_ up = 0.0, name = _('Transparent Switch On/Off'), category = {_('_My Buttons')}},
