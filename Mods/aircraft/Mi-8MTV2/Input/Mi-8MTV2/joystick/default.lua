...
{down = iCommandViewCockpitChangeSeat, value_down = 2, name = _('Set Copilot Seat'),		category = _('View Cockpit')},
{down = iCommandViewCockpitChangeSeat, value_down = 3, name = _('Set Technician Seat'),		category = _('View Cockpit')},
{down = iCommandViewCockpitChangeSeat, value_down = 4, name = _('Set Left Gunner Seat'),	category = _('View Cockpit')},
--{down = iCommandViewCockpitChangeSeat, value_down = 5, name = _('Set Rear Gunner Seat'),	category = _('View Cockpit')},
...
{	down = device_commands.Button_18, value_up = 0,  value_down = 1,	cockpit_device_id = devices.CPT_MECH,	name = _('Open/Close Left Blister'),			category = _('Systems')},
{	down = device_commands.Button_19, value_up = 0,  value_down = 1,	cockpit_device_id = devices.CPT_MECH,	name = _('Open/Close Right Blister'),			category = _('Systems')},
...
{	down = device_commands.Button_108,	cockpit_device_id = devices.ELEC_INTERFACE,		value_down = 1,		name = _('Battery Heating Switch - ON/OFF'),		category = {_('Right Side Panel')}},
{	down = device_commands.Button_107,	cockpit_device_id = devices.ELEC_INTERFACE,		value_down = 1,		name = _('Battery Heating Switch - ON'),			category = {_('Right Side Panel')}},
{	down = device_commands.Button_107,	cockpit_device_id = devices.ELEC_INTERFACE,		value_down = 0,		name = _('Battery Heating Switch - OFF'),			category = {_('Right Side Panel')}},
--
...
-- Electric System Panels
{	down = device_commands.Button_112,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Battery 1 Switch - ON/OFF'),										category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_113,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Battery 2 Switch - ON/OFF'),										category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_114,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Standby Generator Switch - ON/OFF'),								category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_109,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Rectifier 1 Switch - ON/OFF'),									category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_110,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Rectifier 2 Switch - ON/OFF'),									category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_111,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Rectifier 3 Switch - ON/OFF'),									category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_115,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('DC Ground Power Switch - ON/OFF'),								category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_116,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Equipment Test Switch - ON/OFF'),									category = {_('Right Side Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_117,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1,		name = _('DC Voltmeter Selector Switch - CCW'),								category = {_('Right Side Panel'), _('Electric Panels')}},
{	down = device_commands.Button_117,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('DC Voltmeter Selector Switch - CW'),								category = {_('Right Side Panel'), _('Electric Panels')}},
{	pressed = device_commands.Button_118,	cockpit_device_id = devices.ELEC_INTERFACE,	value_pressed = -0.2,	name = _('Standby Generator Voltage Adjustment Rheostat - CCW/Decrease'),	category = {_('Right Side Panel'), _('Electric Panels')}},
{	pressed = device_commands.Button_118,	cockpit_device_id = devices.ELEC_INTERFACE,	value_pressed = 0.2,	name = _('Standby Generator Voltage Adjustment Rheostat - CW/Increase'),	category = {_('Right Side Panel'), _('Electric Panels')}},

------------------------------------------------
-- Electrical Control Panel --------------------
------------------------------------------------
{	down = device_commands.Button_119,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Generator 1 Switch - ON/OFF'),								category = {_('Electrical Control Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_120,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('Generator 2 Switch - ON/OFF'),								category = {_('Electrical Control Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_121,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('AC Ground Power Switch - ON/OFF'),							category = {_('Electrical Control Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_122,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1,		name = _('115V Inverter Switch - Down'),								category = {_('Electrical Control Panel'), _('Electric Panels')}},
{	down = device_commands.Button_122,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('115V Inverter Switch - Up'),									category = {_('Electrical Control Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_123,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1,		name = _('36V Inverter Switch - Down'),									category = {_('Electrical Control Panel'), _('Electric Panels')}},
{	down = device_commands.Button_123,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('36V Inverter Switch - Up'),									category = {_('Electrical Control Panel'), _('Electric Panels')}},
...
{	down = device_commands.Button_124,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1,		name = _('AC Voltmeter Selector Switch - CCW'),							category = {_('Electrical Control Panel'), _('Electric Panels')}},
{	down = device_commands.Button_124,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1,			name = _('AC Voltmeter Selector Switch - CW'),							category = {_('Electrical Control Panel'), _('Electric Panels')}},
{	pressed = device_commands.Button_125,	cockpit_device_id = devices.ELEC_INTERFACE,	value_pressed = -0.2,	name = _('Generator 1 Voltage Adjustment Rheostat - CCW/Decrease'),		category = {_('Electrical Control Panel'), _('Electric Panels')}},
{	pressed = device_commands.Button_125,	cockpit_device_id = devices.ELEC_INTERFACE,	value_pressed = 0.2,	name = _('Generator 1 Voltage Adjustment Rheostat - CW/Increase'),		category = {_('Electrical Control Panel'), _('Electric Panels')}},
{	pressed = device_commands.Button_126,	cockpit_device_id = devices.ELEC_INTERFACE,	value_pressed = -0.2,	name = _('Generator 2 Voltage Adjustment Rheostat - CCW/Decrease'),		category = {_('Electrical Control Panel'), _('Electric Panels')}},
{	pressed = device_commands.Button_126,	cockpit_device_id = devices.ELEC_INTERFACE,	value_pressed = 0.2,	name = _('Generator 2 Voltage Adjustment Rheostat - CW/Increase'),		category = {_('Electrical Control Panel'), _('Electric Panels')}},
...
-- Electric Panel
{	down = device_commands.Button_127,	cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1,		name = _('Net on Rectifier Switch Cover - OPEN/CLOSE'),		category = {_('Center Console'), _('Electric Panels')}},
...
{	down = device_commands.Button_128,	cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1,		name = _('Net on Rectifier Switch - ON/OFF'),				category = {_('Center Console'), _('Electric Panels')}},
...
{	down = device_commands.Button_129,	cockpit_device_id = devices.ELEC_INTERFACE, value_down = 1,		name = _('36V Transformer Selector Switch - Up'),			category = {_('Center Console'), _('Electric Panels')}},
{	down = device_commands.Button_129,	cockpit_device_id = devices.ELEC_INTERFACE, value_down = -1,	name = _('36V Transformer Selector Switch - Down'),			category = {_('Center Console'), _('Electric Panels')}},
