...
{combos = {{key = "JOY_BTN7"}},		pressed = iCommandPlaneTrimDown,			up = iCommandPlaneTrimStop,																									name = _('Elevator Trimmer Switch - PUSH(DESCEND)'),						category = {_('Stick'), _('Flight Control')}},
{combos = {{key = "JOY_BTN9"}},		pressed = iCommandPlaneTrimUp,				up = iCommandPlaneTrimStop,																									name = _('Elevator Trimmer Switch - PULL(CLIMB)'),							category = {_('Stick'), _('Flight Control')}},
