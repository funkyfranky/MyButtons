...
-- Stick ------------------------------------
---------------------------------------------
{combos = {{key = "JOY_BTN3"}},		down = gear_commands.NoseSteering,			up = gear_commands.NoseSteering,			cockpit_device_id = devices.GEAR_INTERFACE,		value_down =  1, value_up = 0,	name = _('Nosewheel Steering Button'),										category = {_('Stick')}},
{combos = {{key = "JOY_BTN11"}},	down = control_commands.AileronLimitOff_EXT,up = control_commands.AileronLimitOff_EXT,	cockpit_device_id = devices.CONTROL_INTERFACE,	value_down =  1, value_up = 0,	name = _('Aileron Limiter (Hold to turn off)'),								category = {_('Stick'), _('Flight Control')}},
{combos = {{key = "JOY_BTN2"}},		down = iCommandPlanePickleOn,				up = iCommandPlanePickleOff,																								name = _('Weapon Release Button'),											category = {_('Stick')}},
{combos = {{key = "JOY_BTN1"}},		down = weapons_commands.TrgFirstDetent,		up = weapons_commands.TrgFirstDetent,		cockpit_device_id = devices.WEAPONS_CONTROL,	value_down =  1, value_up = 0,	name = _('Gun Trigger - FIRST DETENT'), 									category = {_('Stick')}},
{combos = {{key = "JOY_BTN6"}},		down = iCommandPlaneFire,					up = iCommandPlaneFireOff, 																									name = _('Gun Trigger - SECOND DETENT (Press to shoot)'),					category = {_('Stick')}},
{combos = {{key = "JOY_BTN15"}},	down = asg31_commands.DgMode,				up = asg31_commands.DgMode,					cockpit_device_id = devices.AN_ASG31,			value_down = -1, value_up = 0,	name = _('Dogfight/Resume Search Switch - FORWARD (DM)'),					category = {_('Stick')}},
{combos = {{key = "JOY_BTN19"}},	down = asg31_commands.ResumeSearch,			up = asg31_commands.ResumeSearch,			cockpit_device_id = devices.AN_ASG31,			value_down =  1, value_up = 0,	name = _('Dogfight/Resume Search Switch - CENTER-PRESS (RESUME SEARCH)'),	category = {_('Stick')}},
{combos = {{key = "JOY_BTN17"}},	down = asg31_commands.DgMode,				up = asg31_commands.DgMode,					cockpit_device_id = devices.AN_ASG31,			value_down =  1, value_up = 0,	name = _('Dogfight/Resume Search Switch - AFT (DG)'),						category = {_('Stick')}},
{combos = {{key = "JOY_BTN4"}},		down = control_commands.PitchDamperCutoff,	up = control_commands.PitchDamperCutoff,	cockpit_device_id = devices.CONTROL_INTERFACE,	value_down =  1, value_up = 0,	name = _('Pitch Damper Cutoff Switch'),										category = {_('Stick')}},
{combos = {{key = "JOY_BTN7"}},		pressed = iCommandPlaneTrimUp,				up = iCommandPlaneTrimStop,																									name = _('Elevator Trimmer Switch - PUSH(DESCEND)'),						category = {_('Stick'), _('Flight Control')}},
{combos = {{key = "JOY_BTN9"}},		pressed = iCommandPlaneTrimDown,			up = iCommandPlaneTrimStop,																									name = _('Elevator Trimmer Switch - PULL(CLIMB)'),							category = {_('Stick'), _('Flight Control')}},
{combos = {{key = "JOY_BTN10"}},	pressed = iCommandPlaneTrimLeft,			up = iCommandPlaneTrimStop,																									name = _('Aileron Trimmer Switch - LEFT WING DOWN'),						category = {_('Stick'), _('Flight Control')}},
{combos = {{key = "JOY_BTN8"}},		pressed = iCommandPlaneTrimRight,			up = iCommandPlaneTrimStop,																									name = _('Aileron Trimmer Switch - RIGHT WING DOWN'),						category = {_('Stick'), _('Flight Control')}},
