...
{ down = tgp_commands.Ltdr_EXT, up = tgp_commands.Ltdr_EXT, cockpit_device_id = devices.TGP_INTERFACE, value_down =  1.0, value_up= 0.0, name = _('LTD/R Switch ARM/SAFE'), category = {_('_My Buttons')}},
{ down = tgp_commands.Ltdr_EXT, up = tgp_commands.Ltdr_EXT, cockpit_device_id = devices.TGP_INTERFACE, value_down = -1.0, value_up= 0.0, name = _('LTD/R Switch AFT/SAFE'), category = {_('_My Buttons')}},
