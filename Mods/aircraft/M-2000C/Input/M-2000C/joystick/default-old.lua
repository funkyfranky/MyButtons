...
--	elements["PTN_500"] = default_2_position_tumb(_("Target Memory Time Selector Switch"), devices.RADAR, device_commands.Button_500, 500, 0, 1)
	...
	{down = 3506, up = 3506, cockpit_device_id = 11,	value_down = 0,		value_up = 0.5,		name = _('Radar Azimuth WIDE, else MIDDLE'),						category = _('3-Pos. Switch Abstractions')},
	{down = 3506, up = 3506, cockpit_device_id = 11,	value_down = 1,		value_up = 0.5,		name = _('Radar Azimuth NARROW, else MIDDLE'),						category = _('3-Pos. Switch Abstractions')},
	{down = 3502, up = 3502, cockpit_device_id = 11,	value_down = 0,		value_up = 0.5,		name = _('Radar Scan 4-LINE, else 2-LINE'),							category = _('3-Pos. Switch Abstractions')},
	{down = 3502, up = 3502, cockpit_device_id = 11,	value_down = 1,		value_up = 0.5,		name = _('Radar Scan 1-LINE, else 2-LINE'),							category = _('3-Pos. Switch Abstractions')},
	...
	{combos = {{key = 'JOY_BTN2'}},	down = iCommandPlaneChangeLock,																name = _('STT/TWS Toggle'),								category = _('HOTAS')},
	...
	{down = iCommandPlaneRadarCenter,													name = _('TDC DEPRESS (Lock Target)'),						category = _('HOTAS')},
	...
	{down = 3609, up = 3609, cockpit_device_id = 13, value_down = 0,   name = _('Decoy Release Mode OFF'),    category = _('Countermeasures')},
	...
	-- VTB Console
    {down = 3213, up = 3213, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('Radar Target Data Manual Entry Begin'),						category = _('VTB Console')},
	{down = 3213, up = 3213, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('Radar Target Data Manual Entry Ends'),						category = _('VTB Console')},
    {down = 3214, up = 3214, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('N Switch (Waypoint Selector Increase)'),						category = _('VTB Console')},
	{down = 3214, up = 3214, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('N Switch (Waypoint Selector Decrease)'),						category = _('VTB Console')},
    {down = 3215, up = 3215, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('Rho Switch Up (Target Range from Bullseye Increase)'),		category = _('VTB Console')},
	{down = 3215, up = 3215, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('Rho Switch Down (Target Range from Bullseye Decrease)'),		category = _('VTB Console')},
    {down = 3216, up = 3216, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('Theta Switch Up (Target Bearing from Bullsweye Increase)'),	category = _('VTB Console')},
	{down = 3216, up = 3216, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('Theta Switch Down (Target Bearing from Bullseye Decrease)'),	category = _('VTB Console')},
    {down = 3217, up = 3217, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('C Switch Up (Target Heading Increase)'),						category = _('VTB Console')},
	{down = 3217, up = 3217, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('C Switch Down (Target Heading Decrease)'),					category = _('VTB Console')},
    {down = 3218, up = 3218, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('Z Switch Up (Target Altitude Increase)'),						category = _('VTB Console')},
	{down = 3218, up = 3218, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('Z Switch Down (Target Altitude Decrease)'),					category = _('VTB Console')},
    {down = 3219, up = 3219, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('M Switch Up (Target Mach Number Increase)'),					category = _('VTB Console')},
	{down = 3219, up = 3219, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('M Switch Down (Target Mach Number Decrease)'),				category = _('VTB Console')},
    {down = 3220, up = 3220, cockpit_device_id = devices.VTH_VTB,	value_down =  1,	value_up = 0,	name = _('T Switch (Target Age Increase)'),								category = _('VTB Console')},
	{down = 3220, up = 3220, cockpit_device_id = devices.VTH_VTB,	value_down = -1,	value_up = 0,	name = _('T Switch (Target Age Decrease)'),								category = _('VTB Console')},
    ...
    {down = iCommandViewNightVisionGogglesOn,															name = _('NVG Toggle'),										category = _('Pilot & Seat Controls')},
	{down = iCommandPlaneDLK_Target3,																	name = _('Stow/Unstow NVG'),								category = _('Pilot & Seat Controls')},
	{down = iCommandPlaneDLK_Target2,																	name = _('Sun Visor Toggle'),								category = _('Pilot & Seat Controls')},
	{down = iCommandPlaneDLK_Target1,																	name = _('Toggle Mount NVG on helmet'),						category = _('Pilot & Seat Controls')},
	...
	--DEBUG
	{down = iCommandPlane_ABRIS_Axis_Increase,												name = _('DEBUG POS Increase'),		category = _('Debug')},
	{down = iCommandPlane_ABRIS_Axis_Decrease,												name = _('DEBUG POS Decrease'),		category = _('Debug')},
	{down = iCommandPlane_ADF_Test,															name = _('RDI RADAR Drop Lock'),	category = _('Debug')},
}) 
