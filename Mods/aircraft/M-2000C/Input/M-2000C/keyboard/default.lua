...
-- tested
	...
	--HOTAS Stick
	{category = _('HOTAS'), name = _('Weapons FIRE/Bomb Release'),					down = iCommandPlaneFire,					up = iCommandPlaneFireOff,													combos = {{key = 'Space'}},						},
	...
	{category = _('HOTAS'), name = _('STT/TWS Toggle'),								down = iCommandPlaneChangeLock,																							combos = {{key = 'Enter'}},						},
	...
	{category = _('HOTAS'), name = _('Main U/VHF Radio SELECT'),						down = iCommandPlane_HOTAS_MIC_SwitchUp,	up = iCommandPlane_HOTAS_MIC_SwitchOff,			combos = {{key = 'Num+', reformers = {'LShift'}}},	},
	{category = _('HOTAS'), name = _('Aux. UHF Radio SELECT'),							down = iCommandPlane_HOTAS_MIC_SwitchDown,	up = iCommandPlane_HOTAS_MIC_SwitchOff,			combos = {{key = 'Num-', reformers = {'LAlt'}}},	},
	...
	{category = _('HOTAS'), name = _('TDC UP'),											pressed = iCommandPlaneRadarUp,				up = iCommandPlaneRadarStop,					combos = {{key = ';'}},								},
	{category = _('HOTAS'), name = _('TDC DOWN'),										pressed = iCommandPlaneRadarDown,			up = iCommandPlaneRadarStop,					combos = {{key = '.'}},								},
	{category = _('HOTAS'), name = _('TDC LEFT'),										pressed = iCommandPlaneRadarLeft,			up = iCommandPlaneRadarStop,					combos = {{key = ','}},								},
	{category = _('HOTAS'), name = _('TDC RIGHT'),										pressed = iCommandPlaneRadarRight,			up = iCommandPlaneRadarStop,					combos = {{key = '/'}},								},
	{category = _('HOTAS'), name = _('Decoy PANIC release'),							down = iCommandPlaneDropChaffOnce,															combos = {{key = 'Insert'}},						},
	{category = _('HOTAS'), name = _('Jammer ACTIVATE/Standby Toggle'),					down = iCommandActiveJamming,																combos = {{key = 'E'}},								},
	...
	{category = _('HOTAS'), name = _('Radar Antenna UP'),								down = iCommandSelecterUp,					up = iCommandSelecterStop,						value_down=1.0,										},
	{category = _('HOTAS'), name = _('Radar Antenna DOWN'),								down = iCommandSelecterDown,				up = iCommandSelecterStop,						value_down=1.0,										},
	{category = _('HOTAS'), name = _('Radar Antenna CENTER'),							down = iCommandSelecterLeft,																													},
	...
	{category = _('PCA Weapons Management'), name = _('Emergency Jettison'),						cockpit_device_id = devices.PCA, down = 3409, value_down = 1, value_up = 0,					combos = {{key = 'E', reformers = {'LShift'}}},	},
	{category = _('PCA Weapons Management'), name = _('PCA Button 1 SELECT'),						cockpit_device_id = devices.PCA, down = 3235, value_down = 1,								combos = {{key = '1'}},							},
	{category = _('PCA Weapons Management'), name = _('PCA Button 2 SELECT'),						cockpit_device_id = devices.PCA, down = 3237, value_down = 1,								combos = {{key = '2'}},							},		
	{category = _('PCA Weapons Management'), name = _('PCA Button 3 SELECT'),						cockpit_device_id = devices.PCA, down = 3239, value_down = 1,								combos = {{key = '3'}},							},
	{category = _('PCA Weapons Management'), name = _('PCA Button 4 SELECT'),						cockpit_device_id = devices.PCA, down = 3241, value_down = 1,								combos = {{key = '4'}},							},
	{category = _('PCA Weapons Management'), name = _('PCA Button 5 SELECT'),						cockpit_device_id = devices.PCA, down = 3243, value_down = 1,								combos = {{key = '5'}},							},
	{category = _('PCA Weapons Management'), name = _('AG Gun  SELECT'),							cockpit_device_id = devices.PCA, down = 3245, value_down = 1,								combos = {{key = '0', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 1 SELECT'),							cockpit_device_id = devices.PCA, down = 3250, value_down = 1,								combos = {{key = '1', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 2 SELECT'),							cockpit_device_id = devices.PCA, down = 3253, value_down = 1,								combos = {{key = '2', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 3 SELECT'),							cockpit_device_id = devices.PCA, down = 3256, value_down = 1,								combos = {{key = '3', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 4 SELECT'),							cockpit_device_id = devices.PCA, down = 3259, value_down = 1,								combos = {{key = '4', reformers = {'LCtrl'}}},	},
	{category = _('PCA Weapons Management'), name = _('Stores 5 SELECT'),							cockpit_device_id = devices.PCA, down = 3262, value_down = 1,								combos = {{key = '5', reformers = {'LCtrl'}}},	},
    ...
    {category = _('Hydraulic & Mechanical'), name = _('Canopy Position CYCLE'), 				down = iCommandPlaneFonar, 														combos = {{key = 'C',   reformers = {'LCtrl'}}},	},
	...
	{category = {_('Ground Adjustment')}, name = _('Change Matra Type 155 Burst Mode (1/3/6/18)'),	combos = {{key = '1', reformers = {'RShift','RAlt'}}},	down = device_commands.Button_950, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Laser Code, Hundreds (1..8)'),		    combos = {{key = '9', reformers = {'RShift','RAlt'}}},	down = device_commands.Button_951, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Laser Code, Tens (1..8)'),			    combos = {{key = '0', reformers = {'RShift','RAlt'}}},	down = device_commands.Button_952, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Laser Code, Ones (1..8)'),			    combos = {{key = '-', reformers = {'RShift','RAlt'}}},	down = device_commands.Button_953, cockpit_device_id = devices.PPA,	value_down = 1	},
	{category = {_('Ground Adjustment')}, name = _('Change Gun Burst Lenght (0.5 or 1.0)'),	        combos = {{key = '2', reformers = {'RShift','RAlt'}}},	down = device_commands.Button_954, cockpit_device_id = devices.PPA,	value_down = 1	},
