...
--GunSight EZ42
{down = device_commands.Button_14, cockpit_device_id  = devices.EZ42_GUNSIGHT, value_down = 1.0,   name = _('EZ42 Gunsight Gyro Power Switch'), category = _('EZ42 Gunsight')},
{down = device_commands.Button_1, cockpit_device_id = devices.EZ42_GUNSIGHT, value_down = 1.0, name = _('EZ42 Gunsight Gyro Power Switch - On'), category = _('EZ42 Gunsight')},
{down = device_commands.Button_1, cockpit_device_id = devices.EZ42_GUNSIGHT, value_down = 0.0, name = _('EZ42 Gunsight Gyro Power Switch - Off'), category = _('EZ42 Gunsight')},

{down = device_commands.Button_15, cockpit_device_id  = devices.EZ42_GUNSIGHT, value_down = 1.0,   name = _('EZ42 Gunsight Night Lens Filter'), category = _('EZ42 Gunsight')},
{down = device_commands.Button_11, cockpit_device_id = devices.EZ42_GUNSIGHT, value_down = 1.0, name = _('EZ42 Gunsight Night Lens Filter - On'), category = _('EZ42 Gunsight')},
{down = device_commands.Button_11, cockpit_device_id = devices.EZ42_GUNSIGHT, value_down = 0.0, name = _('EZ42 Gunsight Night Lens Filter - Off'), category = _('EZ42 Gunsight')},

{pressed = device_commands.Button_6, cockpit_device_id  = devices.EZ42_GUNSIGHT, value_pressed = -1.0,	 name = _('EZ42 Gunsight Brightness Control - CCW/Increase'), category = _('EZ42 Gunsight')},
...
{down = device_commands.Button_13, cockpit_device_id  = devices.WEAPON_SYSTEM, value_down = 1.0,   name = _('Master Arm ON/OFF'), category = _('Weapon System')},
...
{action = device_commands.Button_1,  cockpit_device_id  = devices.REMOTE_COMPASS,     name = _('Remote Compass Curse Set'),category = _('My Axes')},
{action = device_commands.Button_4,  cockpit_device_id  = devices.REMOTE_CLOCK,       name = _('Clock Turnable Bezel'),category = _('My Axes')},
{action = device_commands.Button_1,  cockpit_device_id  = devices.REMOTE_CLOCK,       name = _('Clock Wind/Set Knob'),category = _('My Axes')},
{action = device_commands.Button_4,  cockpit_device_id  = devices.WEAPON_SYSTEM,      name = _('Set Gun 1 Ammunition Count'),category = _('My Axes')},
{action = device_commands.Button_5,  cockpit_device_id  = devices.WEAPON_SYSTEM,      name = _('Set Gun 2 Ammunition Count'),category = _('My Axes')},
{action = device_commands.Button_6,  cockpit_device_id  = devices.WEAPON_SYSTEM,      name = _('Set Gun 3 Ammunition Count'),category = _('My Axes')},
{action = device_commands.Button_7,  cockpit_device_id  = devices.WEAPON_SYSTEM,      name = _('Set Gun 4 Ammunition Count'),category = _('My Axes')},
{action = device_commands.Button_2,  cockpit_device_id  = devices.EZ42_GUNSIGHT,      name = _('EZ42 Gunsight Target Wingspan Knob'),category = _('My Axes')},
{action = device_commands.Button_3,  cockpit_device_id  = devices.EZ42_GUNSIGHT,      name = _('EZ42 Gunsight Target Distance Control'),category = _('My Axes')},
{action = device_commands.Button_4,  cockpit_device_id  = devices.EZ42_GUNSIGHT,      name = _('EZ42 Gunsight Brightness Control'),category = _('My Axes')},
{action = device_commands.Button_12, cockpit_device_id  = devices.EZ42_GUNSIGHT,      name = _('EZ42 Gunsight Altitude Aiming Correction Adjusting Knob I'),category = _('My Axes')},
...
{action = device_commands.Button_3,  cockpit_device_id  = devices.VHF_RADIO,          name = _('VHF Radio Volume'),category = _('My Axes')},
{action = device_commands.Button_8,  cockpit_device_id  = devices.VHF_RADIO,          name = _('VHF Radio Tuning (+/-30 kHz)'),category = _('My Axes')},
{action = device_commands.Button_3,  cockpit_device_id  = devices.OXYGEN_SYSTEM,      name = _('Oxygen Flow Valve'),category = _('My Axes')},
