...
-- Stick
{down = iCommandPlanePickleOn, up = iCommandPlanePickleOff, name = _('Weapon release'), category = _('Stick')},
{down = iCommandPlaneFire, up = iCommandPlaneFireOff, name = _('MG131/151 fire'), category = _('Stick')},
{down = device_commands.Button_19, up = device_commands.Button_19, cockpit_device_id  = devices.WEAPON_SYSTEM, value_down = 1.0, value_up = 0.0, name = _('MG131 fire'), category = _('Stick')},
...
{action = device_commands.Button_15, cockpit_device_id = devices.CONTROL_SYSTEM, name = _('Radiator Flaps'), category = _('Engine Control')},
